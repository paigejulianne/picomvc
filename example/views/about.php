...
<div class="card">
    <h2>About PicoMVC</h2>
    <p>PicoMVC is a lightweight Model-View-Controller framework for PHP 8.0+ that follows the same design philosophy as PicoORM:</p>
    ...
    <p>PicoMVC supports multiple template engines:</p>
    <ul>
    ...
    <p>PicoMVC is designed to work seamlessly with PicoORM for database operations. Simply create your model classes and use them in your controllers.</p>
</div>
