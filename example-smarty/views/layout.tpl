...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        header { background: #e67e22; color: white; padding: 1rem 0; }
        header h1 { font-size: 1.5rem; }
        nav { margin-top: 0.5rem; }
        nav a { color: #ecf0f1; text-decoration: none; margin-right: 1rem; }
        nav a:hover { text-decoration: underline; }
        main { padding: 2rem 0; min-height: calc(100vh - 200px); }
        footer { background: #d35400; color: #ecf0f1; padding: 1rem 0; text-align: center; }
        .btn { display: inline-block; padding: 0.5rem 1rem; background: #e67e22; color: white; text-decoration: none; border-radius: 4px; }
        ...
        .badge { display: inline-block; padding: 0.25rem 0.5rem; background: #e67e22; color: white; border-radius: 4px; font-size: 0.8rem; }
    </style>
</head>
<body>
    <header>
